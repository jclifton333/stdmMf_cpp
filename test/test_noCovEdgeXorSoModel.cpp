...
TEST(TestNoCovEdgeXorSoModel, TestPar) {
    // generate network
    NetworkInit init;
    init.set_dim_x(3);
    init.set_dim_y(3);
...
TEST(TestNoCovEdgeModel, TestLL) {
    ...
    std::shared_ptr<Model> m(new NoCovEdgeXorSoModel(n));
...
TEST(TestNoCovEdgeXorSoModel,TestLLGradient) {
    // generate network
    NetworkInit init;
    init.set_dim_x(10);
    init.set_dim_y(10);
...
TEST(TestNoCovEdgeXorSoModel,TestLLHessian) {
    // generate network
    NetworkInit init;
    init.set_dim_x(3);
    init.set_dim_y(3);
...
TEST(TestNoCovEdgeXorSoModel, EstPar) {
    NetworkInit init;
    init.set_dim_x(10);
    init.set_dim_y(10);
    init.set_wrap(false);
...
TEST(TestNoCovEdgeXorSoModel, Spillover) {
    NetworkInit init;
    init.set_dim_x(5);
    init.set_dim_y(3);
    init.set_wrap(false);
