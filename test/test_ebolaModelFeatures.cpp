...
TEST(TestEbolaModelFeatures, UpdateFeatures) {
    EbolaData::deinit();
    EbolaData::init();
    // generate network
    NetworkInit init;
    ...
    EbolaModelFeatures ef_get(n, mod);
    EbolaModelFeatures ef_update(n, mod);
...
TEST(TestEbolaModelFeatures, Copy) {
    EbolaData::deinit();
    EbolaData::init();
    // generate network
    NetworkInit init;
    ...
    EbolaModelFeatures ef_get_cpy(ef_get);
    EbolaModelFeatures ef_update_cpy(ef_update);
