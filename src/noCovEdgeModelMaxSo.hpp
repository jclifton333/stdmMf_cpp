#ifndef NO_COV_EDGE_MODEL_MAX_SO_HPP
#define NO_COV_EDGE_MODEL_MAX_SO_HPP
...
class NoCovEdgeModelMaxSo : public Model {
private:
...
public:
    NoCovEdgeModelMaxSo(const std::shared_ptr<const Network> & network);

    NoCovEdgeModelMaxSo(const NoCovEdgeModelMaxSo & other);
