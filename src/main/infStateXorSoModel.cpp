...
InfStateXorSoModel::InfStateXorSoModel(
        const std::shared_ptr<const Network> & network)
    : InfStateModel(6, network), intcp_inf_latent_(0.0), intcp_inf_(0.0),
      intcp_rec_(0.0), trt_act_inf_(0.0), trt_act_rec_(0.0), trt_pre_inf_(0.0) {
}

InfStateXorSoModel::InfStateXorSoModel(const InfStateXorSoModel & other)
...
std::shared_ptr<Model<InfState> > InfStateXorSoModel::clone() const {
    return std::shared_ptr<Model<InfState> >(new InfStateXorSoModel(*this));
}


std::vector<double> InfStateXorSoModel::par() const {
...
void InfStateXorSoModel::par(const std::vector<double> & par) {
...
double InfStateXorSoModel::inf_b(const uint32_t & b_node,
        const bool & b_trt,
...
double InfStateXorSoModel::a_inf_b(const uint32_t & a_node,
...
double InfStateXorSoModel::rec_b(const uint32_t & b_node,
        const bool & b_trt,
        const boost::dynamic_bitset<> & inf_bits,
        const boost::dynamic_bitset<> & trt_bits) const {
    bool b_trt_so = false;
...
std::vector<double> InfStateXorSoModel::inf_b_grad(const uint32_t & b_node,
        const bool & b_trt,
        const boost::dynamic_bitset<> & inf_bits,
        const boost::dynamic_bitset<> & trt_bits) const {
    bool b_trt_so = false;
...
std::vector<double> InfStateXorSoModel::a_inf_b_grad(
...
std::vector<double> InfStateXorSoModel::rec_b_grad(
...
std::vector<double> InfStateXorSoModel::inf_b_hess(const uint32_t & b_node,
        const bool & b_trt,
        const boost::dynamic_bitset<> & inf_bits,
        const boost::dynamic_bitset<> & trt_bits) const {
    bool b_trt_so = false;
...
std::vector<double> InfStateXorSoModel::a_inf_b_hess(
        const uint32_t & a_node, const uint32_t & b_node,
        const bool & a_trt, const bool & b_trt,
        const boost::dynamic_bitset<> & inf_bits,
        const boost::dynamic_bitset<> & trt_bits) const {
...
std::vector<double> InfStateXorSoModel::rec_b_hess(
        const uint32_t & b_node, const bool & b_trt,
        const boost::dynamic_bitset<> & inf_bits,
        const boost::dynamic_bitset<> & trt_bits) const {
    bool b_trt_so = false;
