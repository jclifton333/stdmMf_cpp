#include "brMinStartsSimPerturbAgent.hpp"
...
BrMinStartsSimPerturbAgent<State>::BrMinStartsSimPerturbAgent(
...
template <typename State>
BrMinStartsSimPerturbAgent<State>::BrMinStartsSimPerturbAgent(
        const BrMinStartsSimPerturbAgent & other)
...
template <typename State>
std::shared_ptr<Agent<State> > BrMinStartsSimPerturbAgent<State>::clone() const {
    return std::shared_ptr<Agent<State> >(
            new BrMinStartsSimPerturbAgent<State>(*this));
}


template <typename State>
boost::dynamic_bitset<> BrMinStartsSimPerturbAgent<State>::apply_trt(
...
template <typename State>
std::vector<double> BrMinStartsSimPerturbAgent<State>::train(
...
template<typename State>
void BrMinStartsSimPerturbAgent<State>::rng(
...
template class BrMinStartsSimPerturbAgent<InfState>;
template class BrMinStartsSimPerturbAgent<InfShieldState>;
